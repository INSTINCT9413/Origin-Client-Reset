...
#Region "Functions | Create form"
    ...
    Function CreateBottom(ByVal r As Rectangle, ByVal slope As Integer) As GraphicsPath
        ...
        If _BottomStyle = BottomType.Rounded Then
...
#Region "Properties | Form"
    Enum BottomType As Byte
        Rounded = 0
        NotRounded = 1
    End Enum

    Private _BottomStyle As BottomType = BottomType.NotRounded
    Public Property BottomStyle() As BottomType
        Get
            Return _BottomStyle
        End Get
        Set(ByVal v As BottomType)
            _BottomStyle = v
            Invalidate()
        End Set
    End Property

    Private _GreyRectangle As Boolean = True
    Public Property GreyRectangle() As Boolean
        Get
            Return _GreyRectangle
        End Get
...
#End Region
    ...
    Sub New()
        BottomStyle = BottomType.NotRounded
        GreyRectangle = True
        DoubleBuffered = True
    End Sub
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim LBR2 As New LinearGradientBrush(New Rectangle(0, BH, Width, Height), Color.FromArgb(220, 220, 220), Color.FromArgb(230, 230, 230), 270S)
        ...
        G.FillPath(LBR2, GP2)
        If GreyRectangle = True Then G.FillPath(New SolidBrush(Color.FromArgb(206, 206, 206)), GP3)
        G.FillPath(LBR1, GP1)

        If GreyRectangle = True Then G.DrawLine(New Pen(New SolidBrush(Color.FromArgb(206, 206, 206))), New Point(0, Height - 54), New Point(Width - 3, Height - 54))
        ...
        If ShowIcon = True Then G.DrawIcon(FindForm.Icon, New Rectangle(5, 5, 19, 19))
    End Sub
